...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220918104205_ModifiedFixture")]
    partial class ModifiedFixture
    {
            ...
            modelBuilder.Entity("Domain.Entities.Event", b =>
                {
                    ...
                    b.Property<long?>("GoalAssisterPlayerId")
                        .HasColumnType("bigint");

                    b.Property<long?>("GoalScorerPlayerId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("GoalAssisterPlayerId");

                    b.HasIndex("GoalScorerPlayerId");
            ...
            modelBuilder.Entity("Domain.Entities.Event", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Player", "GoalAssister")
                        .WithMany()
                        .HasForeignKey("GoalAssisterPlayerId");

                    b.HasOne("Domain.Entities.Player", "GoalScorer")
                        .WithMany()
                        .HasForeignKey("GoalScorerPlayerId");
