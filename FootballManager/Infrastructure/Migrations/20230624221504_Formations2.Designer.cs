...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230624221504_Formations2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Formation", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("FormationId"), 1L, 1);
            ...
            modelBuilder.Entity("Domain.Entities.Player", b =>
                {
                    ...
                    b.Property<long?>("StartingElevenPlayers")
                        .HasColumnType("bigint");

                    b.HasKey("PlayerId");

                    b.HasIndex("BenchPlayers");
                    ...
                    b.HasIndex("StartingElevenPlayers");
            ...
            modelBuilder.Entity("Domain.Entities.TeamSheet", b =>
                {
                    ...
                    b.Property<long?>("TeamFormationId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Entities.Player", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.TeamSheet", null)
                        .WithMany("StartingEleven")
                        .HasForeignKey("StartingElevenPlayers");
            ...
            modelBuilder.Entity("Domain.Entities.TeamSheet", b =>
                {
                    b.HasOne("Domain.Entities.Formation", "TeamFormation")
                        .WithMany()
                        .HasForeignKey("TeamFormationId");

                    b.HasOne("Domain.Entities.Tactic", "TeamTactic")
                        .WithMany()
                        .HasForeignKey("TeamTacticId");

                    b.Navigation("TeamFormation");
