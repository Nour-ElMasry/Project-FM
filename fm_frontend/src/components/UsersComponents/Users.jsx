...
const Users = () => {
  ...
  const DeleteUser = (userId) => {
    GeneralAxiosService.deleteMethod(
      "https://localhost:7067/api/v1/Users/" + userId
    ).then(() => setRefresh((prev) => prev + 1));
  };

  useEffect(() => {
    GeneralAxiosService.getMethod(
      "https://localhost:7067/api/v1/Users/All/" + page
    )
  ...
  return (
    <>
      ...
      {hasError && <ErrorMsg />}
      {!loading && !hasError && (
        <div className="userSection container container--pa">
          <TableContainer className="tablesContainer container--styled">
            ...
            >
              ...
              <TableBody>
                {users?.pageResults
                  .filter((u) => u.id !== user.customer.userId)
                  .map((p) => (
                    <TableRow
                      key={p.id}
                    ...
                    >
                      ...
                      <TableCell align="center">
                        {getDate(p.userPerson?.birthDate)}
                      </TableCell>
                      <TableCell align="center">
                        <Button
                          variant="contained"
